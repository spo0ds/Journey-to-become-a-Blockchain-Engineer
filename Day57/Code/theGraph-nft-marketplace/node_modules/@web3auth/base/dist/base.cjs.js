...
const signChallenge = async (payload, chainNamespace) => {
  ...
  const res = await (0,http_helpers_namespaceObject.post)("".concat(authServer, "/siww/get"), data);
...
const verifySignedChallenge = async (chainNamespace, signedMessage, challenge, issuer, sessionTime) => {
  ...
  const idTokenRes = await (0,http_helpers_namespaceObject.post)("".concat(authServer, "/siww/verify"), sigData);
