      ...
      return _regenerator.default.async(function (_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _ref = _args2.length > 0 && _args2[0] !== undefined ? _args2[0] : {}, apiKey = _ref.apiKey, newSession = _ref.newSession, email = _ref.email, showUI = _ref.showUI, redirectURI = _ref.redirectURI, network = _ref.network, locale = _ref.locale, extensions = _ref.extensions, testMode = _ref.testMode, endpoint = _ref.endpoint;
              magic = null;
              ether = null;
            ...
            case 13:
              _context2.prev = 13;
              magic = new Magic(apiKey, (0, _extends2.default)({
                network: network
              }, locale && {
                locale: locale
              }, extensions && {
            ...
            case 24:
              ...
              _context2.next = 27;
              return _regenerator.default.awrap(magic.auth.loginWithMagicLink((0, _extends2.default)({
                email: email
              }, showUI && {
                showUI: showUI
              }, redirectURI && {
