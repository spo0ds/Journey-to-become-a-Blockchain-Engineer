...
exports.updateStreamStatus = exports.StreamNetwork = void 0;
var MoralisStreams_1 = require("../MoralisStreams");
var api_utils_1 = require("@moralisweb3/api-utils");
var core_1 = require("@moralisweb3/core");
var updateStreamEvmStatus_1 = require("../resolvers/updateStreamEvmStatus");
var StreamNetwork;
(function (StreamNetwork) {
    StreamNetwork["EVM"] = "evm";
})(StreamNetwork = exports.StreamNetwork || (exports.StreamNetwork = {}));
var makeUpdateStreamEvmStatus = function (core, _a) {
    var network = _a.network, options = __rest(_a, ["network"]);
    return api_utils_1.EndpointResolver.create(core, MoralisStreams_1.BASE_URL, updateStreamEvmStatus_1.updateStreamEvmStatus).fetch(options);
};
var updateStreamStatus = function (core) { return function (options) {
