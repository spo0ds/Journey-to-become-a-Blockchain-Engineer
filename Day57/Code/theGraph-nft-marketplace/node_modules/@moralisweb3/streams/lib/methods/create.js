...
exports.createStream = exports.StreamNetwork = void 0;
...
var makeCreateStreamEvm = function (core, _a) {
    var network = _a.network, options = __rest(_a, ["network"]);
    return api_utils_1.EndpointResolver.create(core, MoralisStreams_1.BASE_URL, resolvers_1.createStreamEvm).fetch(options);
};
var createStream = function (core) { return function (options) {
