...
exports.saveFlamegraph = exports.createFlamegraphHtmlFile = exports.profileToFlamegraph = void 0;
const fs_1 = __importDefault(require("fs"));
const errors_1 = require("./errors");
const task_profiling_1 = require("./task-profiling");
function profileToFlamegraph(profile) {
    (0, errors_1.assertHardhatInvariant)(profile.end !== undefined, `Formatting invalid task profile for ${profile.name}. No end was recorded.`);
    return {
        name: profile.name,
...
function foldFramegraph(toFold) {
    ...
    children.sort((a, b) => a.parallel === b.parallel ? 0 : b.parallel ? -1 : 1);
    ...
    for (let i = 1; i < children.length; i++) {
        ...
        if (children[i].name === latest.name &&
