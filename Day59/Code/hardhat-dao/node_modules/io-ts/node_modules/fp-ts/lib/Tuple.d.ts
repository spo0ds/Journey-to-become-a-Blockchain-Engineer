...
declare const bimap: <L, A, M, B>(f: (l: L) => M, g: (a: A) => B) => (fa: Tuple<L, A>) => Tuple<M, B>, compose: <L, A>(la: Tuple<L, A>) => <B>(ab: Tuple<A, B>) => Tuple<L, B>, duplicate: <L, A>(ma: Tuple<L, A>) => Tuple<L, Tuple<L, A>>, extend: <L, A, B>(f: (fa: Tuple<L, A>) => B) => (ma: Tuple<L, A>) => Tuple<L, B>, foldMap: <M>(M: Monoid<M>) => <A>(f: (a: A) => M) => <L>(fa: Tuple<L, A>) => M, map: <A, B>(f: (a: A) => B) => <L>(fa: Tuple<L, A>) => Tuple<L, B>, mapLeft: <L, M>(f: (l: L) => M) => <A>(fa: Tuple<L, A>) => Tuple<M, A>, reduce: <A, B>(b: B, f: (b: B, a: A) => B) => <L>(fa: Tuple<L, A>) => B, reduceRight: <A, B>(b: B, f: (a: A, b: B) => B) => <L>(fa: Tuple<L, A>) => B;
